...
from .logic import (
    ...
    pop_categories_from_product_data,
    pop_promotions_from_product_data,
    get_cart_details,
...
from .serializers import (
    ...
    CartHistoryOutputSerializer,
    CartItemInputSerializer,
    CartDetailsOutputSerializer,
)
...
class CategoryView(generics.ListCreateAPIView):
    ...
    def get_serializer_class(
        self,
    ) -> Type[CategoryInputSerializer] | Type[CategoryOutputSerializer]:
        return (
            CategoryInputSerializer
            if self.request.method == "POST"
            else CategoryOutputSerializer
        )
    ...
    def update(self, request, *args, **kwargs) -> Response:
        ...
        for field in fields_to_update:
            setattr(
                category_obj,
                field,
                serializer.validated_data.get(field, getattr(category_obj, field)),
            )
...
class ProductView(generics.ListCreateAPIView):
    ...
    def get_serializer_class(
        self,
    ) -> Type[ProductInputSerializer] | Type[ProductOutputSerializer]:
        return (
            ProductInputSerializer
            if self.request.method == "POST"
            else ProductOutputSerializer
        )
    ...
    def update(self, request: Request, *args, **kwargs) -> Response:
        ...
        for field in fields_to_update:
            setattr(
                product_obj,
                field,
                serializer.validated_data.get(field, getattr(product_obj, field)),
            )
...
class PromotionView(generics.ListCreateAPIView):
    ...
    def get_serializer_class(
        self,
    ) -> Type[PromotionInputSerializer] | Type[PromotionOutputSerializer]:
        return (
            PromotionInputSerializer
            if self.request.method == "POST"
            else PromotionOutputSerializer
        )
    ...
    def update(self, request: Request, *args, **kwargs) -> Response:
        ...
        for field in fields_to_update:
            setattr(
                promotion_obj,
                field,
                serializer.validated_data.get(field, getattr(promotion_obj, field)),
            )
...
class CartView(views.APIView):
    ...
    def put(self, request: Request) -> Response:
        ...
        if cart_item_obj:
            output_serializer = CartDetailsOutputSerializer(cart_item_obj)
            return Response(data=output_serializer.data, status=status.HTTP_200_OK)
        elif cart_item_obj is None:
